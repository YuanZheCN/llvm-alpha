...
const SmallBirdFrameLowering *SmallBirdFrameLowering::create(const SmallBirdSubtarget &ST) {
    return llvm::createSmallBirdSEFrameLowering(ST);
}
...
bool SmallBirdFrameLowering::hasFP(const MachineFunction &MF) const {
