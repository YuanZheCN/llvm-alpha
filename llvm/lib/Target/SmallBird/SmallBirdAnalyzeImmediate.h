//===-- SmallBirdAnalyzeImmediate.h - Analyze Immediates ------------*- C++ -*--===//
//
...
//
//===----------------------------------------------------------------------===//
#ifndef SMALLBIRD_ANALYZE_IMMEDIATE_H
#define SMALLBIRD_ANALYZE_IMMEDIATE_H
...
namespace llvm {
  ...
  class SmallBirdAnalyzeImmediate {
  public:
    struct Inst {
